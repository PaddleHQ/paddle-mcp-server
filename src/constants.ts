export const TOOL_METHODS = {
  ...
  GET_ACTIVE_SUBSCRIBERS: "get_active_subscribers_metrics",
  GET_MONTHLY_RECURRING_REVENUE: "get_monthly_recurring_revenue_metrics",
  GET_REVENUE: "get_revenue_metrics",
  GET_REFUNDS: "get_refunds_metrics",
  GET_CHARGEBACKS: "get_chargebacks_metrics",
  GET_CHECKOUT_CONVERSION: "get_checkout_conversion_metrics",
  GET_MONTHLY_RECURRING_REVENUE_CHANGE: "get_monthly_recurring_revenue_change_metrics",
} as const;
